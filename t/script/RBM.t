...
@diag: "Training two RBM's with a three-peaked distribution"
...
@diag: "Finished preparing data in 't:3' seconds"
...
for idatum to numberOfPatterns
   ...
   weight1## = weight1## + learningRate *
      ... (outer## (input1#, output1#) - outer## (inrec1#, outrec1#))
endfor
t1 = stopwatch

@pass: "Finished training first layer"
@diag: "Process took 't1:3' seconds"
...
for idatum to numberOfPatterns
   ...
   weight2## = weight2## + learningRate *
      ... (outer## (input2#, output2#) - outer## (inrec2#, outrec2#))
endfor
t2 = stopwatch

@pass: "Finished training second layer"
@diag: "Process took 't2:3' seconds"
...
for itest to numberOfTestPatterns
   ...
   @diag: "   Energy in input layer: 'stdev'"
   ...
   @diag: "   Energy in middle layer: 'stdev'"
   ...
   @diag: "   Energy in output layer: 'stdev'"
...
@pass: "Finished drawing test patterns"
@diag: "Process took 't:3' seconds"
